...
//    public static String server = "http://192.168.4.2:8080/esa/esa";
    public static String server = "http://localhost:9999/esa/esa";

    public static EsaInfo getEsa(String query, int limit) throws UnsupportedEncodingException
    {
    ...
    {
        EsaInfo ei = GetEsa.getEsa("Apple Inc.", 10);
